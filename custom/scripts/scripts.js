...
function chartHelper(t) {
    for (var e = [], n = Object.keys(t), i = 0; i < n.length; i++) e.push({
        name: n[i],
        color: colorGenerator(n[i]),
        y: t[n[i]]
    });
    return e
}
...
function redirect() {
    ...
    function F(t, e, n) {
        ...
        if (oe.isEmptyObject(p)) "inline" === ("none" === u ? S(t.nodeName) : u) && (f.display = u);
        else {
    ...
    function I(t, e, n) {
        var i, o, r = 0,
            ...
            c = u.props;
        for (_(c, u.opts.specialEasing); a > r; r++)
    ...
    var ue = function(t) {
        ...
        var x, w, T, C, E, S, k, N, A, D, $, L, j, O, H, R, F, _, I, P = "sizzle" + 1 * new Date,
            M = t.document,
            q = 0,
            B = 0,
            W = n(),
                    ...
                    return 1 === i && 0 === o ? function(t) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[P] || (g[P] = {}), u = c[t] || [], f = u[0] === q && u[1], p = u[0] === q && u[2], d = f && g.childNodes[f]; d = ++f && d && d[m] || (p = f = 0) || h.pop();)
                                    if (1 === d.nodeType && ++p && d === e) {
                                        c[t] = [q, f, p];
                                        break
                                    }
                            } else if (y && (u = (e[P] || (e[P] = {}))[t]) && u[0] === q) p = u[1];
                            else
                                for (;
                                    (d = ++f && d && d[m] || (p = f = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[P] || (d[P] = {}))[t] = [q, p]), d !== e)););
    ...
    oe.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (g) {
                for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = oe.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                    ...
                    }, c.elem = t), e = (e || "").match(be) || [""], s = e.length; s--;) r = Re.exec(e[s]) || [], f = m = r[1], h = (r[2] || "").split(".").sort(), f && (u = oe.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = oe.event.special[f] || {}, d = oe.extend({
                    type: f,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, l), (p = a[f]) || (p = a[f] = [], p.delegateCount = 0, u.setup && u.setup.call(t, i, h, c) !== !1 || (t.addEventListener ? t.addEventListener(f, c, !1) : t.attachEvent && t.attachEvent("on" + f, c))), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), oe.event.global[f] = !0);
                t = null
            }
        },
        remove: function(t, e, n, i, o) {
            ...
            if (g && (c = g.events)) {
                for (e = (e || "").match(be) || [""], u = e.length; u--;)
                    if (s = Re.exec(e[u]) || [], f = m = s[1], h = (s[2] || "").split(".").sort(), f) {
                        ...
                        for (f in c) oe.event.remove(t, f + e[u], n, i, !0);
        ...
        trigger: function(e, n, i, o) {
            ...
            if (s = c = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !He.test(f + oe.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), a = f.indexOf(":") < 0 && "on" + f, e = e[oe.expando] ? e : new oe.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : oe.makeArray(n, [e]), u = oe.event.special[f] || {}, o || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                ...
                for (d = 0;
                    (s = p[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : u.bindType || f, r = (oe._data(s, "events") || {})[e.type] && oe._data(s, "handle"), r && r.apply(s, n), r = a && s[a], r && r.apply && oe.acceptData(s) && (e.result = r.apply(s, n), e.result === !1 && e.preventDefault());
    ...
    Qe.optgroup = Qe.option, Qe.tbody = Qe.tfoot = Qe.colgroup = Qe.caption = Qe.thead, Qe.th = Qe.td, oe.extend({
        clone: function(t, e, n) {
            ...
            if (ne.html5Clone || oe.isXMLDoc(t) || !Ie.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Ke.innerHTML = t.outerHTML, Ke.removeChild(r = Ke.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || oe.isXMLDoc(t)))
        ...
        domManip: function(t, e) {
            ...
            if (u && (s = oe.buildFragment(t, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                ...
                if (o)
                    for (a = r[r.length - 1].ownerDocument, oe.map(r, x), l = 0; o > l; l++) i = r[l], Xe.test(i.type || "") && !oe._data(i, "globalEval") && oe.contains(a, i) && (i.src ? oe._evalUrl && oe._evalUrl(i.src) : oe.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Ve, "")));
                s = n = null
            }
            return this
        }
    ...
    var Tn, Cn, En = oe.expr.attrHandle,
    ...
    oe.fn.extend({
        ...
        removeAttr: function(t, e) {
            var n, i, o = 0,
                r = e && e.match(be);
            if (r && 1 === t.nodeType)
                for (; n = r[o++];) i = oe.propFix[n] || n, oe.expr.match.bool.test(n) ? Nn && kn || !Sn.test(n) ? t[i] = !1 : t[oe.camelCase("default-" + n)] = t[i] = !1 : oe.attr(t, n, ""), t.removeAttribute(kn ? n : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        addClass: function(t) {
            ...
            if (u)
                for (e = (t || "").match(be) || []; l > s; s++)
                    if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace($n, " ") : " ")) {
    ...
    Hn = Bn.exec(Rn.toLowerCase()) || [], oe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
            ...
            var i, o, r, a, s, l, u, c, d = oe.ajaxSetup({}, e),
                ...
                w = {
                    ...
                    getResponseHeader: function(t) {
                        ...
                        if (2 === b) {
                            if (!c)
                                for (c = {}; e = In.exec(a);) c[e[1].toLowerCase()] = e[2];
                            e = c[t.toLowerCase()]
                        }
    ...
    oe.offset = {
        ...
        offset: function(t) {
            ...
            var e, n, i = {
                ...
                o = this[0],
                r = o && o.ownerDocument;
            if (r) return e = r.documentElement, oe.contains(e, o) ? (typeof o.getBoundingClientRect !== Ce && (i = o.getBoundingClientRect()), n = G(r), {
...
function() {
    ...
    O = {}, p = 10, K = !1, I = null, y = null, L = null, q = null, ee = null, i = {
        ...
        return null == n && (n = !0), Z(i.FETCH, {
            url: t.absolute
        }), null != ee && ee.abort(), ee = new XMLHttpRequest, ee.open("GET", t.withoutHashForIE10compatibility(), !0), ee.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"), ee.setRequestHeader("X-XHR-Referer", q), ee.onload = function() {
            var n;
            return Z(i.RECEIVE, {
                url: t.absolute
            }), (n = _()) ? (B(t), W(), f.apply(null, T(n)), j(), "function" == typeof e && e(), Z(i.LOAD)) : document.location.href = v() || t.absolute
    ...
    if (function(t, e, n, i, o, r, a) {
        ...
        var t = {
            ...
            e = document.getElementById("spin"),
            n = new Spinner(t).spin(e);
        setTimeout(function() {
            ...
            success: function(t) {
                n.stop(), $(".loading").hide(), $(".loading-message").remove(), $(".statistics").fadeIn(function() {
                    ...
                    $(".repo-languages p").html(i), $(".code-languages .chart").highcharts({
                        credits: {
                            enabled: !1
                        },
                        chart: {
